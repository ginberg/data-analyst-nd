...
Both test indicate the same finding, namely that the metric gross conversion has a significant difference but the net conversion has not. I have decided not to use the Bonferroni correction, since this the metrics are highly correlated and the results would probably be too conservative.

###Recommendation

I recommend that the new feature of including the 5 or more hour suggestion to the start free trial page is not adopted. The A/B test shows that this will not have a practical significant effect on all evaluation metrics (net conversion).

##Follow-up experiment

A follow-up experiment can consist 
