...
mean(redwine$chlorides)
mean(whitewine$chlorides)
```

### Description Two

I have plotted the quality of wines vs the chlorides, for both colors. The red wines contain more chlorides on average than the white wines, in fact almost twice as much if we calculate the mean values. The lineair model line is decreasing, so the trend is that when increasing the chlorides, the quality drops.
