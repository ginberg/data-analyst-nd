...
In the final plots, I have visualized some interesting insights from the data. The quality histogram (plot1) follows almost a normal distribution, so most wines in the dataset are close to the mean and median value.
